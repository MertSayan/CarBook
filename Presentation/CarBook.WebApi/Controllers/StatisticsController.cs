...
namespace CarBook.WebApi.Controllers
{
    ...
    public class StatisticsController : ControllerBase
    {
        ...
        [HttpGet("GetCarCountBuFuelGasolineOrDiesel")]
        public async Task<IActionResult> GetCarCountBuFuelGasolineOrDiesel()
        {
            var values = await _mediator.Send(new GetCarCountBuFuelGasolineOrDieselQuery());
            return Ok(values);
        }
